...
const AttendanceModal: React.FC<{ training: Training; onClose: () => void; allTrainers: Trainer[] }> = ({ training, onClose, allTrainers }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            // FIX: The transaction() method exists on Dexie, but TypeScript is failing to see it on the subclass instance.
            // Casting 'db' to Dexie resolves this typing issue.
            await (db as Dexie).transaction('rw', db.attendances, db.trainings, async () => {
